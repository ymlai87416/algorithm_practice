...
public class Solution {
    ...
    static{
        try{
            ...
            out2 = new PrintStream(new FileOutputStream("C:\\GitProjects\\algorithm_practice\\temp\\src\\D-test.out"));
        }
        catch(Exception ex) {
            ex.printStackTrace();
        }
        ...
        for(int i=0; i<15; ++i){
            ...
            if(i != 0){
                ...
                if(qLeft == -1){
                    ...
                    leftQ = 9;
                    out.println(qMid+1);
                    out2.println("OUT: " + (qMid+1));
                    String aMid = sc.nextLine();
                    out2.println("IN: " + aMid);
                    ...
                    leftQ = 7;
                    out.println(qLeft+1);
                    out2.println("OUT: " + (qLeft+1));
                    int aLeft = sc.nextInt();
                    out2.println("IN: " + aLeft);
                    out.println(qRight+1);
                    out2.println("OUT: " + (qRight+1));
                    int aRight = sc.nextInt();
                    out2.println("IN: " + aRight);
                    out.println(qMid+1);
                    out2.println("OUT: " + (qMid+1));
                    int aMid = sc.nextInt();
                    out2.println("IN: " + aMid);
                    ...
                    out2.println("IN: " + aRight);
                    out.println(q2Mid+1);
                    out2.println("OUT: " + (q2Mid+1));
                    int a2Mid = sc.nextInt();
                    out2.println("IN: " + a2Mid);
